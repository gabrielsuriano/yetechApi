...
class database {
    ...
    public $user = "imensu76_yetech";
    public $password = "TYLPk(#X[^sv";
    public $db="imensu76_yetech";

	public $database=null;

	private function error_page($error, $sql = "", $values = []) {
        $array = array(
            "error" => $error,
            "sql" => $sql,
        );
	...
	public function connect() {
        ...
        $db = $this->db;
		try {
			$this->database=new PDO("mysql:host=$host;dbname=$db", $user, $password);
	...
	public function insert($table,$values)
	{
		...
		{
			$this->error_page($e->getMessage(), isset($sql) ? $sql : null, $values);
		}
	}
